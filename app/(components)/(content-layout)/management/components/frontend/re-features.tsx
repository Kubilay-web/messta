...
const features = [
  {
    ...
    description:
      "Record for-sale and for-rent properties with full details — area, floor, heating, features, and images — all from one panel.",
    image:
  ...
  },
  {
    ...
    description:
      "Publish listings, track price negotiations, monitor view statistics, and renew listings before they expire.",
    image:
  ...
  },
  {
    title: "👥 Agent Portal",
    description:
      "View each agent's portfolio, attendance and leave records, commission rates, and performance metrics.",
    image:
  ...
  },
  {
    ...
    description:
      "Manage buyer, seller, tenant, and landlord profiles; track budget preferences, favorite listings, and visit history.",
    image:
  ...
  },
  {
    ...
    description:
      "Create sale and rental contracts, track payment schedules, and store documents securely.",
    image:
  ...
  },
  {
    ...
    description:
      "Schedule property showings, assign agents and clients, collect feedback and satisfaction ratings.",
    image:
...
export default function REFeatures() {
  return (
    <section
      id="features"
      ...
      <div className="relative w-full overflow-hidden">
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Digitize your office with modules covering every process from
              property to contract and multiply your productivity.
            </motion.p>
