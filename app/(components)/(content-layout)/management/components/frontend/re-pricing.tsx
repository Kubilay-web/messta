...
const features = [
  "Unlimited Property & Listing Records",
...
const pricingHighlights = [
  ...
  },
  {
    ...
    description: "Special rates for large agencies",
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Transparent, predictable pricing. All features included, no hidden
          fees. Special discounts available for large agencies.
        </motion.p>
            ...
            <CardContent className="p-0">
              <div className="grid lg:grid-cols-2 gap-0">
                <div className="p-8 sm:p-10 lg:p-12 bg-background">
                  ...
                  >
                    {isAnnual ? "Annual" : "Monthly"} Agency License
                  </motion.h3>
                  ...
                  >
                    Full access to our complete real estate management system
                    for all agents in your office. Scalable from boutique
                    agencies to large enterprise chains.
                  </motion.p>
