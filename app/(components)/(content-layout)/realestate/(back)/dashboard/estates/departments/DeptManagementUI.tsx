                          ...
                          <td className="px-4 py-3">
                            <div className="flex items-center justify-end gap-1">
                              ...
                              <button
                                ...
                                title={d._count.agents > 0 ? "Danışmanı olan departman silinemez" : "Sil"}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-1">
                  ...
                  <input {...register("managerName")} placeholder="ör. Ahmet Yılmaz" className={inputCls} />
                </div>
                <div className="space-y-1">
                  <label className="text-sm font-medium">Bütçe (₺)</label>
                  <input {...register("budget")} type="number" step="0.01" placeholder="ör. 50000" className={inputCls} />
                </div>
                <div className="space-y-1">
                  <label className="text-sm font-medium">Bütçe Yılı</label>
                  <input {...register("budgetYear")} placeholder="ör. 2025" className={inputCls} />
                </div>
              </div>
