    ...
    <div className="w-full space-y-4 px-3 sm:px-4 md:px-0">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <Button asChild size="sm" className="gap-1.5">
          <Link href="/realestate/dashboard/users/agents/new">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1.5">
                      <Button asChild size="icon" variant="outline" className="h-8 w-8">
                        <Link href={`/realestate/dashboard/users/agents/view/${a.id}`}>
                          <Eye className="w-3.5 h-3.5" />
                        </Link>
                      </Button>
                      <Button asChild size="icon" variant="outline" className="h-8 w-8">
                        <Link href={`/realestate/dashboard/users/agents/edit/${a.id}`}>
          ...
          return (
            <div key={a.id} className="rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden">
              ...
              <div className="flex justify-end gap-2 px-4 py-2.5 bg-gray-50 border-t border-gray-100">
                <Button asChild size="icon" variant="outline" className="h-8 w-8">
                  <Link href={`/realestate/dashboard/users/agents/view/${a.id}`}><Eye className="w-3.5 h-3.5" /></Link>
                </Button>
                <Button asChild size="icon" variant="outline" className="h-8 w-8">
                  <Link href={`/realestate/dashboard/users/agents/edit/${a.id}`}><Pencil className="w-3.5 h-3.5" /></Link>
                </Button>
                <ToggleButton id={a.id} isActive={a.isActive} onToggle={onToggleActive} />
                <DeleteButton id={a.id} name={name} onDelete={onDelete} />
              </div>
