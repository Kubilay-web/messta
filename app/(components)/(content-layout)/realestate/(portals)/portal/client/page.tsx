...
import {
  ...
  Phone, MapPin, ChevronRight, Clock, Home, User2,
} from "lucide-react";
      ...
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        {stats && stats.pendingPaymentTotal > 0 && (
          <div className="flex items-center justify-between rounded-xl border border-yellow-200 bg-yellow-50 px-4 py-3">
            ...
            <Link href="/realestate/portal/client/payments"
                  ...
                  <div key={c.id} className="rounded-lg border px-3 py-2.5 hover:bg-gray-50 transition-colors">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <div className="text-right shrink-0">
                        <Badge className={cn("text-[10px]", contractStatusColor[c.status] ?? "bg-gray-100 text-gray-700")}>
                          {c.status}
                        </Badge>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {interests.map(({ listing }) => {
                ...
                return (
                  <Link
                    key={listing.id}
                    href={`/realestate/portal/client/listing/${listing.id}`}
