  ...
  const stats = [
    {
      ...
      href: "/realestate/dashboard/users/agents",
      icon: UserCog,
      color: "#8b5cf6",
    },
    {
    ...
    },
    {
      ...
      href: "/realestate/dashboard/estates/listings",
      icon: Building2,
      color: "#10b981",
    },
    {
    ...
    },
    {
      ...
      href: "/realestate/dashboard/estates/payments",
      icon: FileText,
      color: "#ef4444",
    },
  ];
          ...
          <CardHeader className="pb-2">
            <CardTitle className="text-lg font-medium">
              <div className="flex items-center justify-between">
                ...
                <Link
                  href="/realestate/dashboard/estates/visits"
                  className="text-sm font-medium text-blue-500 hover:text-blue-600 transition-colors"
                >
                  Tümünü gör →
                </Link>
