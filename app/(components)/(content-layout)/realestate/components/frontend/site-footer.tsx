        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm text-white/90">
              From property to contract, manage every real estate workflow in
              one platform. Faster closings, higher commissions.
            </p>
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-2">
            <div className="space-y-4">
              ...
              <nav className="flex flex-col space-y-2 text-sm">
                ...
                <Link className="hover:underline" href="/agency-onboarding">
                  Agency Login
                </Link>
              </nav>
            </div>
      ...
      <div className="border-t border-white/10">
        <div className="container flex flex-col items-center justify-center gap-4 py-6 text-center text-sm md:h-16 md:flex-row md:py-0">
          <div className="text-white/60">
            © {new Date().getFullYear()} Real Estate ERP. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
